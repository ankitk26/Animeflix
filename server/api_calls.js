...
const fetchUpcoming = async () => await axios.get(`${BASE_URL}/top/anime/1/upcoming`).then((res) => res.data.top);

// Fetch currently airing anime
const fetchAiring = async () => axios.get(`${BASE_URL}/top/anime/1/airing`).then((res) => res.data.top);

// Fetch anime of a given studio
const fetchStudios = async (id) => axios.get(`${BASE_URL}/producer/${id}`).then((res) => res.data);
